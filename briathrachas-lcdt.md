...
<div class="text-muted">(Gender Recognition Act 2004)</div>
...
<div class="text-muted">(same-gender)</div>
...
<div class="text-muted">(gender reassignment)</div>
...
<div class="text-muted">(pride march)</div>
...
<div class="text-muted">(cogender)</div>
...
<div class="text-muted">(gender equality)</div>
...
<div class="text-muted">(equal rights)</div>
...
<div class="text-muted">(bigender)</div>
...
<div class="text-muted">(bisexual)</div>
...
<div class="text-muted">(intersex)</div>
...
<div class="text-muted">(heterosexual)</div>
...
<div class="text-muted">(sexuality)</div>
...
<div class="text-muted">(heterogender)</div>
...
<div class="text-muted">(multigender)</div>
...
<div class="text-muted">(polysexual)</div>
...
<div class="text-muted">(discrimination)</div>
...
<div class="text-muted">(deadnaming)</div>
...
<div class="text-muted">(misgendering)</div>
...
<div class="text-muted">(gender identity disorder)</div>
...
<div class="text-muted">(surrogate)</div>
...
<div class="text-muted">(agender)</div>
...
<div class="text-muted">(aromantic)</div>

Tha neo-romansach a' toirt iomradh air cuideigin gun mhiann air daoine eile.

#### Neo-shàstachd gnè

<div class="text-muted">(gender dysphoria)</div>
...
<div class="text-muted">(asexual)</div>
...
<div class="text-muted">(gender confirmation surgery)</div>
...
<div class="text-muted">(pangender)</div>
...
<div class="text-muted">(pansexual)</div>

Tha pan-sheòrsach a' toirt iomradh air cuideigin aig a bheil miann air daoine eile ge b' e an gnè aca.

#### Pòsadh aon-sheòrsach

<div class="text-muted">(same-sex marriage)</div>

Pòsadh eadar daoine dhen aon gnè.

#### Pròis

<div class="text-muted">(pride)</div>

Mìneachadh

#### Pròiseil

<div class="text-muted">(proud)</div>
...
<div class="text-muted">(in the closet)</div>
...
<div class="text-muted">(gender spectrum)</div>
...
<div class="text-muted">(gender fluidity)</div>
...
<div class="text-muted">(sexual orientation)</div>
...
<div class="text-muted">(transgender)</div>
...
<div class="text-muted">(transexual)</div>
...
<div class="text-muted">(unigender)</div>

Mìneachadh

#### Uile-sheòrsach

<div class="text-muted">(unisex)</div>

Mìneachadh

{% include scroll-button.html %}
